...
namespace Example {
    public class TextInputGame : Game {
        private GraphicsDeviceManager _graphics;
        private SpriteBatch _spriteBatch;

        public HtmlRunner htmlInstance;
        
        public TextInputGame() {
        ...
        private async void InitializeHtml() {
            ...
            string assetPath = Path.Join(Directory.GetParent(Environment.CurrentDirectory).Parent!.Parent!.FullName, "Examples/TextInput/Assets");
            ...
            htmlInstance = await HtmlProcessor.GenerateRunner("<App/>", 
                    components: HtmlComponents.Create(HtmlComponents.AllInput, HtmlComponents.ReadFrom(Path.Join(scriptPath))));
        }
